...
const useGetMainList = <RecordType extends Record = Record>(
    ...
    const {
        data: { finalIds, finalTotal, finalNextToken, allRecords },
        error,
        loading,
        loaded,
        refetch,
        ...
        (state: ReduxState): DataSelectorResult<RecordType> => {
            ...
            const nextToken = get(state.admin.resources, [
                resource,
                'list',
                'cachedRequests',
                requestSignature,
            ...
            const mainNextToken = get(state.admin.resources, [
                resource,
                'list',
                'nextToken',
            ]); 
            ...
            const finalNextToken = typeof nextToken === 'undefined' ? mainNextToken : nextToken;
            ...
            return memo.current.result as any;
        },
        () => 0,
        isDataLoaded
    );
